...
android {
    ...
    defaultConfig {
        ...
        val apkPrefixLabels = listOf("android-testutils", libraryVersion, buildNumber)
...
sonar {
    properties {
        ...
        property("sonar.projectKey", "albertoirurueta_irurueta-android-test-utils")
        property("sonar.projectName", "irurueta-android-test-utils")
...
mavenPublishing {
    ...
    coordinates("com.irurueta", "irurueta-android-test-utils", libraryVersion)

    pom {
        name.set("irurueta-android-test-utils")
        description.set("Test utilities for Android")
        inceptionYear.set("2025")
        url.set("https://github.com/albertoirurueta/irurueta-android-test-utils/")
        licenses {
            license {
                name.set("Apache License 2.0")
                url.set("https://github.com/albertoirurueta/irurueta-android-test-utils/blob/main/LICENSE")
                distribution.set("https://github.com/albertoirurueta/irurueta-android-test-utils/blob/main/LICENSE")
            }
        }
        developers {
            developer {
        ...
        scm {
            url.set("https://github.com/albertoirurueta/irurueta-android-test-utils/")
            connection.set("scm:git:github.com/albertoirurueta/irurueta-android-test-utils.git")
            developerConnection.set("scm:git:ssh://github.com/albertoirurueta/irurueta-android-test-utils.git")
        }
    }
}
